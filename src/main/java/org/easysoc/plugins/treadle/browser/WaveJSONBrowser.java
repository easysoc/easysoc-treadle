...
public class WaveJSONBrowser {
    ...
    private void createUIComponents() {
        ...
        if (actionGroup.getChildrenCount() == 0) {
            actionGroup.add(new AnAction("Copy WaveJSON Data to Clipboard","Copy WaveJSON data to clipboard", AllIcons.Actions.Copy) {
                @Override
...
//        return "file://" + "/media/itviewer/linux/easysoc/easysoc-treadle/src/main/webapp/index.html";
        String pluginDir = PathManager.getPluginsPath();
        return "file://" + pluginDir + "/easysoc-treadle/webapp/index.html";
    }
