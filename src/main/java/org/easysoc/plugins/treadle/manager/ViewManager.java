...
//        root.removeAllChildren();
        ...
        List<String> inputs = JavaConverters.seqAsJavaList(engine.symbolTable().inputPortsNames().toSeq())
        ...
        List<String> outputs = JavaConverters.seqAsJavaList(engine.symbolTable().outputPortsNames().toSeq())
                .stream().sorted().collect(Collectors.toList());
        ...
        List<String> registers = JavaConverters.seqAsJavaList(engine.symbolTable().registerNames().toSeq())
                .stream().sorted().collect(Collectors.toList());
